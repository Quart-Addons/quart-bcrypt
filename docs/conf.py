...
project = u'Quart-Bcrypt'
copyright = u'2022, Chris Rood'
...
htmlhelp_basename = 'Quart-Bcryptdoc'
...
latex_documents = [
  ('index', 'Quart-Bcrypt.tex', u'Quart-Bcrypt Documentation',
   u'Chris Rood', 'manual'),
]
...
man_pages = [
    ('index', 'quart-bcrypt', u'Quart-Bcrypt Documentation',
     [u'Chris Rood'], 1)
]