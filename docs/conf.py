...
latex_documents = [
    (master_doc, 'QuartBcrypt.tex', 'Quart Bcrypt Documentation',
     'Chris Rood', 'manual'),
]
...
man_pages = [
    (master_doc, 'quart bcrypt', 'Quart Bcrypt Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Quart Bcrypt', 'Quart Bcrypt Documentation',
     author, 'Quart Bcrypt', 'One line description of project.',
     'Miscellaneous'),
]
